...
// バブルソート
export async function bubbleSort(array, onSwap, onCompare) {
  const arr = [...array]
  const n = arr.length
...
// クイックソート
export async function quickSort(array, onSwap, onCompare, start = 0, end = null) {
  const arr = [...array]
...
// マージソート
export async function mergeSort(array, onSwap, onCompare) {
  const arr = [...array]
...
// 挿入ソート
export async function insertionSort(array, onSwap, onCompare) {
  const arr = [...array]
  const n = arr.length
...
// 選択ソート
export async function selectionSort(array, onSwap, onCompare) {
  const arr = [...array]
  const n = arr.length
...
// ヒープソート
export async function heapSort(array, onSwap, onCompare) {
  const arr = [...array]
  const n = arr.length
